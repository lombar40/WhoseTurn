...
public class UsersServiceImpl extends RemoteServiceServlet implements
    ...
    @SuppressWarnings("unchecked")
    @Override
    public final String addGuest(final String username) {
        // Get rid of any leading and trailing whitespace in the username and
        // email address
        username.trim();
        ...
        userResults = (List<edu.unlv.cs.whoseturn.domain.User>) userQuery
                .execute(loggedUser.getEmail());
    ...
    @SuppressWarnings("unchecked")
    @Override
    public final List<String> findAllGuests() {
        PersistenceManager pm = PMF.get().getPersistenceManager();
        Query query = pm.newQuery(edu.unlv.cs.whoseturn.domain.User.class,
                "ownerKeyString != ''");
    ...
    @SuppressWarnings("unchecked")
    @Override
    public final List<String> findMyGuests() {
        /**
         * The persistence manager.
         */
        PersistenceManager pm = PMF.get().getPersistenceManager();
        ...
        Query guestQuery = pm.newQuery(edu.unlv.cs.whoseturn.domain.User.class,
                "ownerKeyString == ownerKeyStringParam");
        ...
        try {
            results = (List<edu.unlv.cs.whoseturn.domain.User>) guestQuery
                    .execute(ownerKeyString);
            if (!results.isEmpty()) {
                for (edu.unlv.cs.whoseturn.domain.User e : results) {
                    resultStringList.add(e.getUsername());
                }
