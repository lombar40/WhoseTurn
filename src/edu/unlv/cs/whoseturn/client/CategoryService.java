...
public interface CategoryService extends RemoteService {
	...
	/**
	 * A way to help populate the database with some useful info, for testing, debugging, etc.
	 */
	public void loadInitialCategories();
	
	/**
	 * Returns a list of all strategies in the system. Useful for when adding a new category.
	 * 
