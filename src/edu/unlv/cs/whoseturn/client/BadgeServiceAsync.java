...
/**
 * Interface for the Badge Service, async version.
 */
public interface BadgeServiceAsync {
     ...
     * turn was selected. Awards the Team Cheater badge to the submitting user.
     * 
     * @param turn
     *            The turn to analyze to determine if someone gets the badge.
     * @param callback The async callback.
     ...
     * for 50 turns. Awards the Saint badge.
     * 
     * @param user
     *            The user to check to see if they are a saint.
     * @param callback The async callback.
     * @throws IllegalArgumentException
     */
     ...
     * participated in a turn with more than 10 people. Awards the Socialite
     * badge.
     * 
     * @param turn
     *            The turn to analyze to determine if someone gets the badge.
     ...
     * 
     * @param user
     *            The user to check to see if they get the storm shadow award.
     * @param callback The async callback.
     * @throws IllegalArgumentException
     */
     ...
     * 
     * @param user
     *            The user to check to see if they get a myth busters award.
     * @param callback The async callback.
     * @throws IllegalArgumentException
     */
    ...
    /**
     * Used to calculateBadges. This method initiates the calculation of all
     * badges.
     * 
     * @param turn
     *            The turn to analyze.
