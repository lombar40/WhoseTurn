...
public class UserProfileDisplay extends AbstractNavigationView implements NavigationView {
	...
	public final Widget bodyAsWidget() {
		...
		Image cornerStone = new Image("images/badges/CornerStone50x50trans.png");
		cornerStone.setAltText("Corner Stone");
		panel.add(cornerStone, 206, 133);
		cornerStone.setSize("50px", "50px");

		Image snowWhite = new Image("images/badges/SnowWhite50x50trans.png");
		...
		Image crappedOut = new Image("images/badges/CrappedOut50x50trans.png");
		...
		Image socialite = new Image("images/badges/Socialite50x50trans.png");
		...
		Image fML = new Image("images/badges/FML50x50trans.png");
		fML.setAltText("FML");
		panel.add(fML, 342, 274);
		fML.setSize("50px", "50px");

		Image saint = new Image("images/badges/Saint50x50trans.png");
		...
		Image dwarf = new Image("images/badges/Dwarf50x50trans.png");
		panel.add(dwarf, 275, 274);
		dwarf.setSize("50px", "50px");

		Image luckyNo7 = new Image("images/badges/LuckNo750x50trans.png");
		panel.add(luckyNo7, 135, 274);
		luckyNo7.setSize("50px", "50px");

		Image humanSacrifice = new Image("images/badges/HumanSacrifice50x50trans.png");
		humanSacrifice.setAltText("Human Sacrifice");
		panel.add(humanSacrifice, 342, 133);
		humanSacrifice.setSize("50px", "50px");

		Image sixMinuteAbs = new Image("images/badges/SixMinuteAbs50x50trans.png");
		sixMinuteAbs.setAltText("Six Minute Abs");
		panel.add(sixMinuteAbs, 206, 201);
		sixMinuteAbs.setSize("50px", "50px");

		Image teamCheater = new Image("images/badges/TeamCheater50x50trans.png");
		...
		Image notTheThumb = new Image("images/badges/NotTheThumb50x50trans.png");
		panel.add(notTheThumb, 135, 201);
		notTheThumb.setSize("50px", "50px");

		Image pickUpSticks = new Image("images/badges/PickUpSticks50x50trans.png");
		panel.add(pickUpSticks, 275, 201);
		pickUpSticks.setSize("50px", "50px");

		Image crossStreams = new Image("images/badges/DontCrossTheStreams50x50trans.png");
		panel.add(crossStreams, 275, 133);
		crossStreams.setSize("50px", "50px");

		Image statSpeaking = new Image("images/badges/StatisticallySpeaking50x50trans.png");
		...
		Image jackass = new Image("images/badges/Jackass50x50trans.png");
		jackass.addClickHandler(new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				MyPopup myPopup = new MyPopup("WAT");
	...
	/**
	 * Pops up a box upon click to display information.
	 * Reference: http://www.gwtapps.com/doc/html/com.google.gwt.user.client.ui.PopupPanel.html
	 */
	private static class MyPopup extends PopupPanel {

		public MyPopup(String content) {
