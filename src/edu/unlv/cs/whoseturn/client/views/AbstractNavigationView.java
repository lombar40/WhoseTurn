...
/**
 * An abstract class which hasw the asWidget() method implemented. This allows for views of the 
 * navigationView type to automatically have the navigation bar at the top.
 * 
 * By including the navigation bar as part of the view, we are able to make sure that if a user
 * logs out that the navigation bar will no longer display at the top of the screen.
 */
